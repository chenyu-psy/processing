...
export const SCREEN_INFO = {
  ...
  startTrialButton: {
    ...
    de: ` <p>Der nächste Durchgang beginnt in <span id="clock" style="color:red">10</span> Sekunden.</p>
    <p>Klicken Sie auf die Schaltfläche "Weiter", um direkt zu beginnen.</p>`,
    cn: ` <p>下一个试次将在 <span id="clock" style="color:red">10</span> 秒后开始。</p>
    <p>点击“继续”按钮后将直接开始</p>`,
  },
      ...
      case "cn":
        return `<div class='main'>
          ...
          <p class='fb-text'>
            ...
            实验将在 <span id='break' style='color:red'>${TIMING.BREAK}</span> 秒后继续。
          </p>
      ...
      case "en":
        return `<div class='main'>
          ...
          <p class='fb-text'>
            ...
            The next block will start in <span id='break' style='color:red'>${TIMING.BREAK}</span> seconds.
          </p>
...
export const END_INFO = {
  ...
  completedOffline: {
    en: `<div class="main">
          ...
          Please copy the following completion code and enter it into Prolific manually: ${CODES.OFFLINE}.
          </p>
          </div>`,
    cn: `<div class="main">
          ...
          请复制以下完成代码并手动输入至Prolific：${CODES.OFFLINE}。
          </p>
          </div>`,
  },
};
...
export const SURVEY_INFO = {
  TITLE_INFO: {
    cn: `事后问卷`,
    en: `Post-Experiment Questionnaire`,
  },
  DESCRIPTION: {
    cn: `<div class="main">本问卷的内容仅用于实验数据的处理，对您是否能够获取实验报酬没有影响。请您如实填写。</div>`,
    en: `<div style="white-space: normal; word-wrap: break-word; overflow-wrap: break-word; line-height: 1.5; max-width: 1200px;">
  ...
  JUDGE_FREQ_QUES: {
    en: "In this study, we asked you to judge the size of objects. How often were you committed to engaging in this task?",
    cn: "在本研究中，您是否始终进行大小判断任务？",
  },
  ...
  JUDGE_DIFF_QUES: {
    en: "How difficult did you find the size judgement task?",
    cn: "您认为大小判断任务有多难？",
  },

  JUDGE_DIFF_MARKS: {
    en: ["Very easy", "Very difficult"],
    cn: ["非常容易", "非常困难"],
  },

  AID_USE_QUES: {
    en: "Did you use any aids (e.g., pencil-and-paper or computer files) to improve your memory performance?",
    cn: "您是否使用任何辅助工具（例如纸笔或电脑文件）来提高您的记忆表现？",
  },

  AID_USE_OPT: {
    en: ["Yes, I did", "No, I did not use any aid"],
    cn: ["是的，我使用了", "不，我没有使用任何辅助工具"],
  },
  ...
  ATTENTION_OPT: {
    en: ["Yes, I was distracted by something", "No, I was able to concentrate"],
  },
  COMMENT_QUES: {
    cn: "您对本次实验是否有任何建议或意见？",
